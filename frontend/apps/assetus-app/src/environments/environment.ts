...
// Single environment for assetus — fail-safe by construction. appEnvironmentConfig
...
//
// Reuses the shared sneat production Firebase project (sneat-eur3-1) — assetus
// shares auth, spaces and Firestore with the rest of the sneat ecosystem.
export const assetusAppEnvironmentConfig: IEnvironmentConfig =
  appEnvironmentConfig({
    ...
    firebaseConfig: {
      ...
      // assetus.app, assetus-app.web.app, or a preview channel. (assetus.app is a
