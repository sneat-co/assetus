...
// Authenticated landing page for assetus.app. Reuses the shared
  ...
  template: `
    <ion-header>
      <ion-toolbar>
        ...
        <ion-title>Assetus.app</ion-title>
      </ion-toolbar>
    </ion-header>
...
export class AssetusHomePageComponent {}
